...
module.exports.run = async function ({
    ...
    const money = args[1]
    if (money < 500 || isNaN(money)) return api.sendMessage("Mức đặt cược của bạn không phù hợp hoặc dưới 500$!!!", event.threadID, event.messageID);
    ...
    try {
        ...
        if (choose == ketquaGame) {
            ...
            await Currencies.increaseMoney(event.senderID, parseInt(money * 0.85))
